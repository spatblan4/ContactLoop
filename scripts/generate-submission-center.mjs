...
const groups = [
  ...
  ['technical', '技术材料', [
    ...
    ['tech-setup', '最终核对可复现安装与测试说明', '发布前按全新环境重跑 README 步骤。', false],
  ...
  ['repository', '公开仓库', [
    ...
    ['repo-readme', '完善英文 README 与运行说明', '当前根 README 内容不足，提交前必须补齐。', false],
    ['repo-license', '添加 MIT 或 Apache License', '确保 GitHub About 区域能够识别许可证。', false],
    ['repo-disclosure', '披露赛前已有工作', 'README 区分 Before the hackathon 与 Built during。', false],
    ['repo-privacy', '最终扫描 secrets 与真实学生信息', '发布前检查 tracked files 与提交历史。', false],
  ]],
  ['devpost', 'Devpost 提交', [
    ['devpost-description', '填写英文项目介绍', '说明功能、用户、问题、实现与影响。', false],
    ['devpost-pitch', '项目名与一句话 Pitch', '保持和视频、README、文章一致。', false],
